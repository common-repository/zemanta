<?php
/*
Copyright (c) 2007 - 2016, Sovrn
The copyrights to the software code in this file are licensed under the (revised) BSD open source license.

Plugin Name: Editorial Assistant by Sovrn
...
class Zemanta {
	...
	public function __construct()
	{
		...
		register_deactivation_hook(dirname(__FILE__) . '/zemanta.php', array($this, 'deactivate'));
        ...
        // setup mixpanel
        $this->mixpanel = new zemanta_analytics("ef0f7a11e41c9b6da92490c75b45e141");
	}
	...
	*/
	public function init()
	{
        ...
        // active install
        $this->mixpanel->active_install("ednet");
	}
	...
	*/
	...
	{
		$this->fix_user_meta();
        $this->mixpanel->create_profile([], "ednet");
        $this->mixpanel->update_profile_property("ednet_activated", true);
        $this->mixpanel->track("ednet_activated");
	}

    /**
	* deactivate
	*
	* Run any functions needed for plugin deactivation
	*/
	public function deactivate()
	{
        $this->mixpanel->create_profile([], "ednet");
        $this->mixpanel->update_profile_property("ednet_activated", false);
        $this->mixpanel->track("ednet_activated");
	}
