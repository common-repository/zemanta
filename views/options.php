...
<div class="wrap" id="wp-zemanta">
    ...
    <div class="logo"><img src="<?php echo plugins_url('/img/sovrn-logo.svg', dirname(__FILE__)); ?>" alt="Sovrn | social blogging" /></div>
	...
	<div class="cols clearfix">
		...
		<form method="get" action="">
			<fieldset>
				...
				<input class="button-primary" type="submit" name="zemanta_upload_articles" value="<?php _e('Upload my articles to Sovrn','zemanta');?>">
			</fieldset>
		</form>
		<?php else: ?>
