...
#wp-zemanta .signin-button {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, from(#8c8888), to(#666666)); /* Safari 4+, Chrome */
  background-image: -webkit-linear-gradient(top, #8c8888, #666666); /* Chrome 10+, Safari 5.1+, iOS 5+ */
  background-image:    -moz-linear-gradient(top, #8c8888, #666666); /* Firefox 3.6-15 */
  background-image:      -o-linear-gradient(top, #8c8888, #666666); /* Opera 11.10-12.00 */
  background-image:         linear-gradient(to bottom, #8c8888, #666666); /* Firefox 16+, IE10, Opera 12.50+ */
